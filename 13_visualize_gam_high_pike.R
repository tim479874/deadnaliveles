...
#load gam data
load("/ma_elephant/R/gam_pike.RData")
...
tiff("map_fv_hp.tiff", units="in", width=20, height=20, res=400, pointsize = 24)

grid.arrange(cod_gar_fv,ken_lai_fv,ken_tsv_fv,tcd_zak_fv,xwa_tbc_fv )
...
tiff("map_res_hp.tiff", units="in", width=20, height=20, res=400, pointsize = 24)

grid.arrange(cod_gar_res,ken_lai_res,ken_tsv_res,tcd_zak_res,xwa_tbc_res )
...
tiff("cond_eff_high_res_hp.tiff", units="in", width=20, height=20, res=300, pointsize = 24)
...
tiff("cond_eff_high_res_effects.tiff", units="in", width=20, height=20, res=300, pointsize = 24)

grid.arrange(DCplothp,BSploth,WTploth,PIploth)
dev.off() 
...
############################################################### 
tiff("cond_eff_cat_hp.tiff", units="in", width=20, height=20, res=300, pointsize = 24)
g2 <- ggplotGrob(PAploth)
g3 <- ggplotGrob(LCploth)
